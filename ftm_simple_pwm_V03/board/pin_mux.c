...
- pin_list:
  ...
  - {pin_num: '1', peripheral: FTM2, signal: 'CH, 1', pin_signal: TSI0_CH11/PTD1/FTM0_CH3/FTM2_CH1/FXIO_D1/TRGMUX_OUT2, direction: OUTPUT}
  ...
  - {pin_num: '14', peripheral: FTM0, signal: 'CH, 1', pin_signal: ADC0_SE4/TSI0_CH19/PTD16/FTM0_CH1, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTD1 (pin 1) is configured as FTM2_CH1 */
