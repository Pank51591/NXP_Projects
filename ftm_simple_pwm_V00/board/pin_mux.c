...
- pin_list:
  ...
  - {pin_num: '15', peripheral: FTM0, signal: 'CH, 0', pin_signal: ADC0_SE2/TSI0_CH20/PTD15/FTM0_CH0, direction: INPUT}
...
void BOARD_InitPins(void)
{
    ...
    /* PORTD16 (pin 16) is configured as FTM0_CH1 */
